...
func RenderOrgHTML(o OrgReport, generatedAt time.Time) string {
	...
	b.WriteString(dashboardHead("ODS AI Attribution — Organization",
		"Since "+html.EscapeString(o.Since)+" · "+fmt.Sprintf("%d", o.ReposCovered)+" repositories · attribution from Co-Authored-By / Assisted-by trailers"))
...
`, o.AICommitShare*100, o.AICommits, o.TotalCommits,
	...
	b.WriteString(trendSection(o.Buckets))
	b.WriteString(toolSection(o.ToolBreakdown()))
